...
const target = `          <label className="flex items-center gap-2 text-sm font-semibold text-slate-700">
            <input type="checkbox" checked={actual.requiere_chip || false} onChange={(e) => {
...
console.log('Removed from TabProductos');
