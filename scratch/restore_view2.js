...
const replacementBlock = `          placa: formCaja.placa,
        ...
        if (formCaja.tipoCertificado === 'GNV_ANUAL') {
          ...
          if (formGnv.verificaciones && formGnv.verificaciones.length > 0) {
            await faregasCertificadosApi.guardarVerificacionesGnv(certificadoId, { verificaciones: formGnv.verificaciones });
          }
          ...
          if (formGlp.componentes && formGlp.componentes.length > 0) {
            await faregasCertificadosApi.guardarComponentesGlp(certificadoId, { componentes: formGlp.componentes });
          }
          if (formGlp.verificaciones && formGlp.verificaciones.length > 0) {
            await faregasCertificadosApi.guardarVerificacionesGlp(certificadoId, { verificaciones: formGlp.verificaciones });
          }
...
if (code.includes('placa: formCaja.placa,\n          categoria: formCaja.categoria\n        });')) {
...
if(code.includes(verificacionStepBlock)) {
